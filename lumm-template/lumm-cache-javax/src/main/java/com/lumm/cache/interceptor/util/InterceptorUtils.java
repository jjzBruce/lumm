...
public abstract class InterceptorUtils {
    ...
    public static boolean isInterceptorClass(Class<?> interceptorClass) {
        if (AnnotationUtil.hasAnnotation(interceptorClass, INTERCEPTOR_ANNOTATION_TYPE)) {
     ...
     * @return
     */
    private static boolean hasNonPrivateConstructorWithoutParameters(Class<?> type) {
